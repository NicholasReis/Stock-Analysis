...
class Stock:
	...
	def __init__(self, stock_symbol, years):
		...
		#This is where I will store the stock and files and whatnot
		#Then I can send the string to DataGrabber
		#This just doesn't make sense to separate from data-grabber anymore
		#If I remove data-grabber I can store the info here without files
		#As long as they are separate I will need to create a stock in
		#data grabber to fill and return
		#I'll think about this on a walk and decide how I feel about how to move forward
		self.load_data(year, label, data)
